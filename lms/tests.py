...
class LessonsAndSubscriptionTests(APITestCase):
    def setUp(self):
        ...
        self.lesson1 = Lesson.objects.create(name="Lesson 1", description="L1", course=self.course, owner=self.owner)
        self.lesson2 = Lesson.objects.create(name="Lesson 2", description="L2", course=self.course, owner=self.other)
    ...
    def test_create_lesson(self):
        ...
        data = {'name': 'New Lesson', 'description': 'New', 'course': self.course.id, 'url': 'https://www.youtube.com/watch?v=abc123'}
